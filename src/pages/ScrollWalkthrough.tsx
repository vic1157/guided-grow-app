          ...
          {[...Array(totalSteps)].map((_, index) => (
            <div
              ...
              className={`h-2 w-12 rounded-full transition-colors ${
                currentStep > index ? "bg-foreground" : "bg-muted-foreground/30"
              }`}
            />
          ))}
        </div>
        ...
        {currentStep === 5 && (
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm text-muted-foreground max-w-lg mx-auto">
                After reading, journal your personal reflections and choose who can see them.
              </p>
            </div>
            ...
            <div className="space-y-4 pt-2">
              <div className="border-2 border-foreground/20 rounded-lg p-4 bg-card space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-foreground mb-3">Visibility</h3>
              ...
              <div className="p-4 bg-accent/50 rounded-lg border border-border">
                <p className="text-sm text-foreground">
                  <span className="font-semibold">Share or keep private:</span> Your reflections are yours to control. Share to encourage others or keep them between you and God.
                </p>
              </div>
            </div>
